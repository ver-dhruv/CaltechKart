...
/**
 * Returns the body of the asset, or NULL if there is none. The user does not
 * have ownership of the body.
...
/**
 * Sets the body of the asset, if possible. The user no longer has
